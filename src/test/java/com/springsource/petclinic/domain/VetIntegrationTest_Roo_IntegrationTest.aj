...
privileged aspect VetIntegrationTest_Roo_IntegrationTest {
    ...
    public void VetIntegrationTest.testFlush() {
        ...
        obj.flush();
        org.junit.Assert.assertTrue("Version for 'Vet' failed to increment on flush directive", obj.getVersion() > currentVersion || !modified);
    }
    ...
    public void VetIntegrationTest.testMerge() {
        ...
        obj.merge();
        obj.flush();
        org.junit.Assert.assertTrue("Version for 'Vet' failed to increment on merge and flush directive", obj.getVersion() > currentVersion || !modified);
    }
